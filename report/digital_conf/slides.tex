...
\begin{frame}{What the data says, before we ask any question}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.36\textwidth}\small
      ...
      \footnotesize Events and controversies that resonate only inside one language community.
      \vspace{0.6em}

      \keyword{Cross-lingual clusters} ($H \approx 1.1$)\\
      \footnotesize Debates that attract equal participation from all three communities.
      \vspace{0.8em}

      \footnotesize\textcolor{mutedgray}{\textit{The next two slides show one example text per topic.}}
    \end{column}
  \end{columns}
  \vspace{0.2em}
...
\end{frame}
% ---- Slide 6.5b: Monolingual peaks with examples --------------------------
...
\begin{frame}{Cross-lingual clusters — shared concerns across all three languages}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.33\textwidth}
      ...
      \textcolor{mutedgray}{\scriptsize Topic 3 · 149 docs · ZH 36\% / EN 34\% / JA 30\%}
      \vspace{0.4em}
      ...
      候補者に『病的で危険な自己嫌悪』を
      強いるものであり、
      司教たちはこの政策を本当に実施するつもりなのか明確にすべきだ。」\\[0.3em]
    ...
    \begin{column}{0.33\textwidth}
      ...
      \textcolor{mutedgray}{\scriptsize Topic 7 · 119 docs · EN 39\% / JA 30\% / ZH 31\%}
      \vspace{0.4em}
    ...
    \begin{column}{0.33\textwidth}
      ...
      \textcolor{mutedgray}{\scriptsize Topic 36 · 25 docs · ZH 36\% / EN 32\% / JA 32\%}
      \vspace{0.4em}

      \begin{block}{Example (ZH)}
      \scriptsize
      「主流派教会は両側から挟み撃ちにされている。
      右派からは自由すぎると攻撃され、
      世俗的左派には相手にされない。
      アメリカの宗教的地盤の17\%しか代表していない。」\\[0.3em]
      \textcolor{mutedgray}{\textit{(Mainline churches squeezed from both sides — too liberal for the right, irrelevant to the secular left; only 17\% of the religious landscape.)}}
      \end{block}
      \vspace{0.2em}
